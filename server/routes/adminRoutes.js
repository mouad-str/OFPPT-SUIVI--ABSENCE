...
router.delete('/absence/:recordId', protect, authorize('admin'), correctAbsence);
...
router.post('/schedule/import', protect, authorize('admin'), upload.single('file'), importSchedule);
